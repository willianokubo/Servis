...
$us_nome = filter_input(INPUT_POST, 'us_nome');
$s_nome = filter_input(INPUT_POST, 's_nome');
...
$valor_cobrado = $valor_venda; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
...
$dadosboleto["endereco2"] = "Cidade - SP -  CEP: 00000-000";

// INFORMACOES PARA O CLIENTE
$dadosboleto["demonstrativo1"] = "Pagamento de Compra no Servis";
$dadosboleto["demonstrativo2"] = "Mensalidade referente a Seris<br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
$dadosboleto["demonstrativo3"] = "BoletoPhp - http://www.boletophp.com.br";

// INSTRU��ES PARA O CAIXA
$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: servis@servis.com";
...
$dadosboleto["endereco"] = "Rua Consolação, 250";
$dadosboleto["cidade_uf"] = "São Paulo / SP";
$dadosboleto["cedente"] = "Servis Company";
